...
| <picture>  <source srcset=".github/images/QuantoFlx.Misc/IconSquare/BlankPanel_0.png" media="(prefers-color-scheme: light)">  <source srcset=".github/images/QuantoFlx.Misc/IconSquare/BlankPanel_1.png" media="(prefers-color-scheme: dark)" >  <img src=".github/images/QuantoFlx.Misc/IconSquare/BlankPanel_0.png" width="32"></picture> | Blank Panel | Make your own panel. | Customizable size | You can write your own Meter/Measures. Up to 16 clone skins can exist at the same time. |
...
| <picture>  <source srcset=".github/images/QuantoFlx.Misc/IconSquare/DividingLine_0.png" media="(prefers-color-scheme: light)">  <source srcset=".github/images/QuantoFlx.Misc/IconSquare/DividingLine_1.png" media="(prefers-color-scheme: dark)" >  <img src=".github/images/QuantoFlx.Misc/IconSquare/DividingLine_0.png" width="32"></picture> | Dividing Line | Dividing lines. | Customizable size | Up to 16 clone skins can exist at the same time. |
